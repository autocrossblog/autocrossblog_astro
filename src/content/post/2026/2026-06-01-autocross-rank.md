---
title: "Introducing Autocross Rank: A New Way to Track Your Progress"
excerpt: "Introducing Autocross Rank, a new system to track your autocross performance and progress over time, against over 90,000 drivers."
author: chris
publishDate: 2026-06-01T11:20:00+06:00
# updateDate: 2024-12-12T11:20:15-06:00
url: 2026/autocross-rank
tags: [autocross,rank, performance, drivers, pick the winners]
image: ~/assets/images/2026/june/AutocrossRank-6-1-2026.png
keywords: "autocross,rank, performance, drivers, pick the winners"
---
After more than two decades in autocross, I've spent countless time contemplating an idea, how can we rank drivers from around the country (world?) and try to allow a driver to compare themselves to the best of the best. For many years I simply couldn't get my head around the scope of the project, but with the advent of AI software development tooling I finally got around to working on the idea, [AutocrossRank.com](https://www.autocrossrank.com).

I knew the struggle was going to be getting "Data" into a useable format, there are hundreds of organizations that put on events every year around the country, and few of them use exactly the same timing software and results formats for each and every event. 
...
In early March however I really jumped in, I threw a bunch of prompts and ideas at every AI coding tool I could leverage (GitHub Copilot, ChatGPT/Codex and Claude) and started making progress. I was able to get a working portal up and running in just a few hours and started with processing data from the SCCA Solo National Championships and Tour results. By early April I was comfortable enough with the site to open it up to the world, though with a small rollout really only promoting it via my personal social media (FB) to start.

A great group of users stepped up and started helping me out, providing very good feedback, suggestions, and even starting to upload results from various local events. Things took off from there and the site has grown rapidly since, with over 90,000 drivers in the database and more than 7,000 events processed. But what does this all mean?

Here's a brief intro to what I am looking to try to do with the site, and of course, please provide me feedback or suggestions on how to make it better.
...
The result is a ranking system designed specifically for autocross. [Be sure to check out our FAQ for some clarifying questions and answers](https://www.autocrossrank.com/about).

Is this ranking perfect? Absolutely not, but it's a start. There are going to be instances of "bad data" or results that shouldn't be included in the rankings (Test & Tune events for example can be uploaded, but we've tried to mark them to NOT be included). If you come across something funny that doesn't look right, just reach out (once you're logged in there's a "Report a Data Problem" link on just about every page, feel free to use it). 
...
First things first, [get registered on the website](https://www.autocrossrank.com/login). Once you're registered you can start uploading results from your local events, and you can also help by providing feedback on the site, reporting data issues, and sharing the site with your autocross friends.
...
The Pick The Winners contest is coming, we've already got the functionality building out and will have it ready to go shortly after Solo Nationals registration opens up in the next two weeks. The PTW contest this year will leverage ARS as well! 
