...
---
After more than two decades in autocross, I've spent countless hours contemplating an idea, how can we rank drivers from around the country (world?) and allow drivers to compare themselves to the best of the best.. For many years I simply couldn't get my head around the scope of the project, but with the advent of AI software development tooling I finally got around to working on the idea, [AutocrossRank.com](https://www.autocrossrank.com).
