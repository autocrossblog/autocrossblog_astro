...
tags: [ 350z, nissan, alignment, video ]
---
import YouTubeEmbed from "/src/components/common/YouTubeEmbed.astro";
import { Image } from 'astro:assets';
import image1 from '~/assets/images/PublishThumbnails/Open-Live-Writer/The-2016-Autocross-Season-So-Far_137CF/image_2.png';

So it has been a while since I've had the time to get a blog post up here, so let's get started.

<YouTubeEmbed videoId="gH1Iwcm0suc" title="Sunday STU 350z Dixie Champ Tour 2016 - Autocross" publishDate="2016-04-23T00:21:33+00:00" description="Project350z Autocross run from Sunday March 20, 2016 Dixie Champ Tour" />
